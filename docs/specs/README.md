...
| UX-001 | Rust Askama/web tests plus recorded Chromium login, error, consent, denial, approval, protocol-error, logout, focus, and 320-pixel responsive checks; keyboard-only and assistive-technology checks remain manual release gates |
