...
| OPS-002 | `make release-smoke` (two-instance OIDC and restore drill), canonical independent deployment-secret generators, zeroizing database credential initialization, release build, readiness, and real-client manual gates |
